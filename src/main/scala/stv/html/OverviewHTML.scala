...
/** There are several overview pages, one with all the simulations and one with just the "featured" sims. This is the common code.
  */
abstract class AbstractOverview extends Page {
  ...
  def resultsTableFootnotes = div(cls := "blockIndent footnotes")(
    ...
    ol(
      li(
        strong("Number of Local MPs"),
        " is the total number of MPs representing specific ridings.  " +
          "Those ridings may be either single-member ridings or multi-member."
      ),
      li(
        strong("Number of Regional MPs"),
        " is the total number of MPs that represent multiple ridings. " +
          "This happens in systems with top-up seats such as MMP and RU-PR."
      ),
      li(
        strong("Over-Representation by Party"),
        " is the percentage of MPs in Parliament minus the " +
      ...
      li(
        strong("Gallagher Index"),
        " is a measure of disproportionality. " +
      ...
      li(
        strong("Gallagher Index Composite"),
        " is the average of the Gallagher Indices for each province and " +
      ...
      li(
        strong("% Voters with Preferred Local MP"),
        " is the percentage of voters who have an MP " +
      ...
      li(
        strong("% Voters with Preferred Regional MP"),
        " is the percentage of voters who have an MP " +
      ...
      li(
        strong("Short System Name"),
        " is a very consise ",
        a(href := "shortName.html")("abbreviation"),
  ...
  def observations = div(
    ...
    div(cls := "blockIndent")(
      ul(
        ...
        li(p(
          """All of the parties are currently """,
          a(href := "../fptp/index.html#subsets")("disadvantaged by FPTP"),
  ...
  def representationSummary(sims: List[Sim]) = {
    ...
    def footnotes = div(cls := "blockIndent footnotes")(
      ...
      ol(
        li(
          strong("Number of Local MPs"),
          " is the total number of MPs representing a specific riding.  " +
        ...
        li(
          strong("Number of MPs"),
          " is the sum of the local and regional MPs, or how many seats in " +
            "Parliament is assumed by this model."
        ),
        li(
          strong("Average Local MPs/Riding"),
          " is the average number of MPs representing a local riding.  For" +
        ...
        li(
          strong("Average Top-up Seats/Region"),
          " is useful for systems like MMP and RU-PR where it gives" +
            " the average number of seats in the top-up region."
        ),
        li(
          strong("Average Total MPs/Region"),
          " is the average number of MPs representing a region -- the sum " +
        ...
        li(
          strong("Area Represented by Median Local MP"),
          " is a measure of the area covered by a local MP.  In " +
  ...
  protected def tableRows(sims: Seq[Sim], f: Sim => TypedTag[String]): Seq[TypedTag[String]] =
    for (sim <- sims.sortBy(s => (s.design.design_name.entryName, s.params.electionStrat.sm.name, s.params.electionStrat.mm.name))) yield f(sim)
  ...
  def modelSummary(sims: List[Sim]) = {
    ...
    val header = thead(
      tr(td("Region"), td(), td("# Tot Seats"), td("% Seats"), td("Avg # Seats/Region"), td("Avg #Reg/Prov"), td("Avg Adjust Seats / Region"), td()),
      tr(
        td("Riding"),
        td("Year"),
        td("# Tot Seats"),
  ...
  protected def toc = div(cls := "blockIndent")(
    p("This page:"),
    ul(
...
/** ************************************
  ...
  * ***********************************
  */
case class OverviewFeaturedHTML(sims: List[Sim], numAllSims: Int, val pgTitle: String, val outFile: String) extends AbstractOverview {
  ...
  private val whatsNew =
    div(cls := "whatsNew")(
      ...
      p(
        strong("2016-10-05"),
        ": Added a few simulations based on 2006, 2008, and 2011 elections. " +
      ...
      p(
        strong("2016-10-12"),
        ": Added AV+ to the list of featured systems.  Several changes to the Vote " +
      ...
      p(
        strong("2017-02-26"),
        ": Added a made-in-Canada model that offers many advantages. See ",
        a(href := "../LPR_no_topup/index.html")("Local Proportional Representation (no topups)"),
        " and ",
        a(href := "../LPR_with_topups/index.html")("Local Proportional Represenation (with topups)"),
        " for ",
        "more details."
      )
    )
  private val introduction = div(
    ...
    div(cls := "blockIndent")(
      ...
      ${sims.length} systems I view as most interesting.  For the """,
        a(href := "allSimulations.html")(s"full list of $numAllSims simulations"),
        """, please see the "All Systems"
      ...
      p(
        ...
        a(href := "../ModellingElections_en.pdf")("submission"),
        " to the Parlimentary Electoral Reform Committee."
      ),
      p(
        """With respect to the Committee's first principle of Effectiveness and Legitimacy, the recommendations
...
/** Created by bwbecker on 2016-06-29.
  */
case class OverviewSpecifiedSystemsHTML(sims: List[Sim], val pgTitle: String, val outFile: String, intro: TypedTag[String]) extends AbstractOverview {
