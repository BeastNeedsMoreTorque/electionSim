...
object Output {
  ...
  private def allSimsIntro = div(
    ...
    div(cls := "blockIndent")(
      p(
        """This page summarizes all of the modelling.  Other pages focus on the systems I find """,
        a(href := "index.html")("most interesting"),
        " and on modelling done at the request of the ",
  ...
  private def erreIntro = div(
    ...
    The next day they passed a motion asking for more work within three constraints:"""),
      ol(
        li("Keep the composite Gallagher index as low as possible."),
